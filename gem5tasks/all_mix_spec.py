...
parser.add_argument("--after-warmM", type=int, default=20)
...
if __name__ == '__main__':
	...
	mix_spec_run(['mcf-sphinx3','omnetpp-sphinx3','mcf-xalancbmk','omnetpp-xalancbmk',
	'xalancbmk-hmmer_retro','mcf-omnetpp','omnetpp-xalancbmk'],
