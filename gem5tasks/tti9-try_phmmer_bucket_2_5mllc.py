...
def find_tb_mspec(workloads, run_once_script, out_dir_path, threads=1, ncores=128):
	...
	base_arguments.append('--l3_assoc=10')
		...
		while len(workloads) > 0 or len(pending_proc) > 0:
			...
			for workload in workloads[:can_launch]:
				if len(pending_proc) < max_pending_proc:
					...
					result_path = os.path.join(out_dir_path, f"l3-{waymask_set}/l2-nopart/l3-tb-{l3_tb_freq}-{l3_tb_inc}")
...
if __name__ == '__main__':
	log_dir = f"/nfs/home/zhangchuanqi/lvna/5g/ff-reshape/log/new_hw_test/period_hmmer_o3_0-period_hmmer_o3_3-period_hmmer_o2_0-period_hmmer_o2_2/2560kBLLC/9tti/try-tb/"
