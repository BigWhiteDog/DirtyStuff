...
def single_redis_run(workloads, run_once_script, out_dir_path, warmup=20_000_000,
	...
	base_arguments.append("--enable-clint-sets=0")
...
if __name__ == '__main__':
	...
	task_loads = [f'npbfta{i}' for i in range(1,3)]
	# task_loads = [f'500_xapian{i}'for i in range(20,100,60)]
	# task_loads = [f'user_redis{i}'for i in range(0,29,10)]
	single_redis_run(task_loads,
